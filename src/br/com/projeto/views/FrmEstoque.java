...
public class FrmEstoque extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        ProdutoDAO dao = new ProdutoDAO(); // Instanciando
        List<Produtos> lista = dao.listarProduto(); // Pegando o método da lista de produtos em um Array
        dados.setNumRows(0); // Limpando a lista de produtos da tabela

        // Percorrer minha lista e exibir 
    ...
    private void initComponents() {
        ...
        tblControEstoPro.addAncestorListener(new javax.swing.event.AncestorListener() {
